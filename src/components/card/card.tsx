      ...
      <div className='info'>
        <div className="info__box info__box--top">
          ...
          <div className="info__icons">
            <svg className={`info__deliver ${seen ? 'info__deliver--seen' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`info__deal ${seen ? 'info__deliver--seen' : ''}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
